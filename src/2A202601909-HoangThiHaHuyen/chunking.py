...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep the punctuation attached to its sentence.  Besides ordinary
        # spaces, ``\s+`` also covers the documented ``.\n`` boundary.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Reattach separators so sentence/paragraph punctuation is not lost.
        parts = [
        ...
        for part in parts:
            ...
            if current_chunk and len(candidate) > self.chunk_size:
                chunks.extend(self._split(current_chunk.strip(), next_separators))
                current_chunk = ""
